  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="../CardDistributedSystem/viewAssosiate?page_type=admin_page&page=0" class="nav-link">View Assosiate</a></li>
          <li class="nav-item"><a href="alerts.html" class="nav-link">Add New Assosiate</a></li>
          <li class="nav-item"><a href="buttons.html" class="nav-link">View Assosiate(Date-Wise)</a></li>
          <li class="nav-item"><a href="cards.html" class="nav-link">View Topup(Date-Wise)</a></li>
          <li class="nav-item"><a href="icons.html" class="nav-link">View KYC(Date-Wise)</a></li>
          <li class="nav-item"><a href="modal.html" class="nav-link">View Topup(Member-Wise)</a></li>
		  <li class="nav-item"><a href="modal.html" class="nav-link">View Assosiate(Mobile No)</a></li>
        </ul>
		<a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
...
<%= Errormessage%>
       ...
       <footer class="br-footer">
		...
		<h6 class="d-flex align-items-center justify-content-between mg-b-30">© Copyright 2021 STAR WING.. | <a href="#">Top</a></h6>
