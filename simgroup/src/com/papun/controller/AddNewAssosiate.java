...
@WebServlet(urlPatterns={"/addNewAssosiate"})
public class AddNewAssosiate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public AddNewAssosiate() {
        super();
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( page_type.equals("addNewAssosiate")) {
			...
			//request.getRequestDispatcher("index.jsp").forward(request, response); 
			request.getRequestDispatcher("/AddNewAssosiate.jsp").forward(request, response); 
