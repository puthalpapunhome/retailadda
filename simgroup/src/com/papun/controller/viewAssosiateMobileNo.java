...
@WebServlet(urlPatterns={"/viewAssosiateMobileNo"})
public class viewAssosiateMobileNo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public viewAssosiateMobileNo() {
        super();
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( page_type.equals("viewAssosiateMobileNo")) {
