...
@WebServlet(urlPatterns={"/viewTopupDateWise"})
public class viewTopupDateWise extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public viewTopupDateWise() {
        super();
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( page_type.equals("viewTopupDateWise")) {
