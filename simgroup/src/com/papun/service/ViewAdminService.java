...
public class ViewAdminService {
	...
	public String getTdData(List<AdminLogin> empList,HttpSession session,String page) {
			...
			if(i==start_page || i>start_page ) {
				...
				if(i%2==0) {
					...
					td_html.append("<tr style=\"background-color: #f2f2f2\">" + 
							...
							"					     <td>"+type+"</td>"+
							"					      <td style=\"color:red;\"><a href=\"../CardDistributedSystem/viewAdmin_Control?id="+empList.get(i).getId()+"\">control</a></td> "+
	...
	public String getHtmlResponse_viewAdmin(List<AdminLogin> empList,HttpSession session,String Page) {
		// TODO Auto-generated method stub
		String html="";
		try {
			html="<!DOCTYPE html>\r\n" + 
					...
					"      <th style=\"color:black;\">Admin Name</th>\r\n" + 
					"      <th style=\"color:black;\">Admin Type</th>\r\n" + 
					"      <th style=\"color:black;\">Control Access</th>\r\n" + 
